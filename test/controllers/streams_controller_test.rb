...
class StreamsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create stream" do
    assert_difference('Stream.count') do
      post streams_url, params: { stream: { code: @stream.code, name: @stream.name, sequence_number: @stream.sequence_number, subject_id: @stream.subject_id } }
    end
  ...
  test "should update stream" do
    patch stream_url(@stream), params: { stream: { code: @stream.code, name: @stream.name, sequence_number: @stream.sequence_number, subject_id: @stream.subject_id } }
