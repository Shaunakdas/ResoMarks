...
class ExamsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create exam" do
    assert_difference('Exam.count') do
      post exams_url, params: { exam: { code: @exam.code, exam_date: @exam.exam_date, name: @exam.name, sequence_number: @exam.sequence_number } }
    end
  ...
  test "should update exam" do
    patch exam_url(@exam), params: { exam: { code: @exam.code, exam_date: @exam.exam_date, name: @exam.name, sequence_number: @exam.sequence_number } }
